...
\begin{code}
{-# OPTIONS --without-K --exact-split --no-sized-types --no-guardedness --auto-inline --lossy-unification #-} --safe
...
open import DedekindReals.Symmetry.Views
...
open import DedekindReals.Symmetry.Subactions
open import DedekindReals.Symmetry.S2
open import DedekindReals.Symmetry.MetaRelations
open import DedekindReals.Symmetry.Relations-S2

{- Refactoring plan:

Symmetry.Reals.Actions
